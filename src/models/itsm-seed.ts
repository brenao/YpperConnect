      ...
      : [
          {
            ...
            data: d(pi === 1 ? -9 : -3),
            autor: p.gerente,
            descricao: "Frente em andamento conforme cronograma acordado com as áreas envolvidas.",
...
export const SEED_RESOURCES: Resource[] = [
  {
    ...
    equipe: "Sustentação de Sistemas",
    horasDia: 8,
    disponibilidadeProjetos: 80,
  },
  {
    id: "RES-02",
    nome: "Bruna Sato",
    papel: "Analista de Infraestrutura",
    equipe: "Infraestrutura",
    horasDia: 8,
    disponibilidadeProjetos: 70,
  },
  {
    id: "RES-03",
    nome: "João Vitor",
    papel: "Analista de Service Desk",
    equipe: "Service Desk",
    horasDia: 8,
    disponibilidadeProjetos: 50,
  },
  {
    id: "RES-04",
    nome: "Patrícia Nunes",
    papel: "Analista de Processos",
    equipe: "Governança de TI",
    horasDia: 8,
    disponibilidadeProjetos: 70,
  },
  {
    id: "RES-05",
    nome: "Tiago Mendes",
    papel: "Especialista em Dados",
    equipe: "Dados e BI",
    horasDia: 8,
    disponibilidadeProjetos: 60,
  },
];
...
export const SEED_USERS: DirectoryUser[] = [
  ...
  },
  {
    ...
    id: "USR-03",
    nome: "Bruna Sato",
    email: "bruna.sato@empresa.com.br",
    login: "EMPRESA\\bruna.sato",
    departamento: "Tecnologia da Informação",
    equipe: "Infraestrutura",
    origem: "ad",
    admin: false,
  ...
  },
  {
    ...
    id: "USR-04",
    nome: "João Vitor",
    email: "joao.vitor@empresa.com.br",
    login: "EMPRESA\\joao.vitor",
    departamento: "Tecnologia da Informação",
    equipe: "Service Desk",
    origem: "ad",
    admin: false,
  ...
  },
  {
    ...
    id: "USR-05",
    nome: "Patrícia Nunes",
    email: "patricia.nunes@empresa.com.br",
    login: "EMPRESA\\patricia.nunes",
    departamento: "Tecnologia da Informação",
    equipe: "Governança de TI",
    origem: "ad",
    admin: false,
  ...
  },
  {
    ...
    id: "USR-06",
    nome: "Tiago Mendes",
    email: "tiago.mendes@empresa.com.br",
    login: "EMPRESA\\tiago.mendes",
    departamento: "Tecnologia da Informação",
    equipe: "Dados e BI",
    origem: "ad",
    admin: false,
  ...
  {
    perfilId: "PRF-USUARIO",
    id: "USR-07",
    nome: "Camila Duarte",
    email: "camila.duarte@empresa.com.br",
    login: "EMPRESA\\camila.duarte",
  ...
  },
  {
    ...
    id: "USR-08",
    nome: "Eduardo Prado",
    email: "eduardo.prado@empresa.com.br",
    login: "EMPRESA\\eduardo.prado",
...
export const SEED_SYSTEMS: SystemRegistry[] = [
  {
    id: "SYS-01",
    nome: "ERP Protheus",
    descricao: "Gestão financeira, fiscal e suprimentos.",
  ...
  },
  {
    ...
    descricao: "Autoatendimento de RH e holerites.",
    categoria: "Aplicações",
    responsavelId: "USR-05",
    atribuicaoId: "USR-04",
    equipe: "Service Desk",
    criticidade: "media",
    ativo: true,
  },
  {
    ...
    descricao: "Diretório corporativo de identidade e acessos.",
    categoria: "Infraestrutura",
  ...
  },
  {
    id: "SYS-04",
    nome: "Data Warehouse",
    descricao: "Base analítica e painéis executivos.",
    categoria: "Dados",
    responsavelId: "USR-06",
    atribuicaoId: "USR-06",
    equipe: "Dados e BI",
    criticidade: "media",
    ativo: true,
  ...
  {
    id: "SYS-05",
    nome: "Rede e Wi-Fi das unidades",
    descricao: "Conectividade das lojas e escritórios.",
    categoria: "Redes",
    responsavelId: "USR-03",
    atribuicaoId: "USR-03",
    equipe: "Infraestrutura",
